 ...
 * Visual style: light bordered pills, right-aligned, section divider lines (matches mobile hub income/expense).
 */
    ...
    >
      <div className="flex flex-wrap justify-end gap-2">
        <button
          type="button"
          onClick={expandAll}
          className="rounded-md border border-gray-200 bg-gray-50 px-3 py-1.5 text-sm font-medium text-slate-700 min-h-[40px] hover:bg-gray-100 active:bg-gray-200/80"
        >
          Expand all
        </button>
        <button
