      ...
      <table className="w-full min-w-[1200px] table-fixed text-sm leading-relaxed">
        ...
        <tbody>
          <tr className="border-t-[3px] border-gray-300/90 bg-gray-100/95 shadow-[0_-6px_16px_-10px_rgba(15,23,42,0.12)]">
            ...
            />
            <td
              className={`sticky right-0 z-10 min-w-[11rem] border-l border-gray-200 bg-gray-100/95 ${TABLE_CELL_X} ${TABLE_CELL_Y} text-center shadow-[-6px_0_10px_-4px_rgba(0,0,0,0.06)] sm:min-w-[12rem]`}
              aria-hidden
            />
          </tr>
        </tbody>
