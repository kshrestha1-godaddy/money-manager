...
export function ExpenseForm({ 
    ...
    useEffect(() => {
        ...
        // Only clear notes when category changes to non-specific category AND notes are empty
        // This prevents clearing existing notes when editing an expense
        if (categoryName !== 'electricity' && categoryName !== 'gold' && !formData.notes) {
            handleInputChange('notes', '');
            setIsAutoGeneratedNotes(false);
        }
    }, [categoryName, formData.notes]);
