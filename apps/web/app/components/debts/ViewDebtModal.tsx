                ...
                <div className="bg-gray-50 px-6 py-4 border-b border-gray-200">
                    <div className="flex justify-between items-center">
                        <div className="flex-1 min-w-0">
                            <h2 className="text-2xl font-bold text-gray-900 truncate">{debt.borrowerName}</h2>
                            <p className="text-base text-gray-600 truncate">{debt.purpose || 'Personal Loan'}</p>
                        </div>
                ...
                <div className="p-6 overflow-y-auto max-h-[calc(90vh-8rem)]">
                    ...
                    <div className="grid grid-cols-4 gap-6 mb-8">
                        ...
                        <div className="bg-orange-50 p-4 rounded-lg">
                            ...
                            <p className="text-2xl font-bold text-orange-900">{formatCurrency(remainingWithInterest.interestAmount, userCurrency)}</p>
                    ...
                    <div className="mb-8">
                        <div className="flex justify-between items-center mb-2">
                            ...
                            <span className="text-gray-600">{repaymentPercentage.toFixed(1)}% complete</span>
                        </div>
                        ...
                        <div className="flex justify-between items-center mt-2 text-gray-600">
                            <span>{formatCurrency(totalRepayments, userCurrency)} repaid</span>
                            <span>{formatCurrency(remainingAmount, userCurrency)} remaining</span>
                        </div>
                    </div>
                    ...
                    {debt.repayments && debt.repayments.length > 0 && (
                        <div className="mb-8">
                            <div className="flex justify-between items-center mb-4">
                                ...
                                <span className="text-gray-600">{debt.repayments.length} payment{debt.repayments.length !== 1 ? 's' : ''}</span>
                            </div>
