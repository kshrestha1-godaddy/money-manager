...
import { uploadTransactionImage, TransactionImageResponse } from "../../actions/transaction-images";
import { uploadImageToBlob, SimpleUploadResult } from "../../actions/simple-image-upload";
import { TransactionImageType } from "../../types/financial";
...
export function TransactionImageUpload({ 
    value, 
    onChange, 
    disabled = false, 
    transactionType,
    ...
    const handleFileSelect = async (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            if (transactionId) {
                // If we have a transaction ID, use the full upload function
                ...
                const result: TransactionImageResponse = await uploadTransactionImage(formData);
                ...
                // If no transaction ID (new transaction), just upload to blob storage
            ...
            <div className="space-y-2">
                {!previewUrl ? (
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="text-sm">
                                {isUploading ? (
                                    ...
                                    <>
                                        <span className="font-medium">{getPlaceholderText()}</span>
                    ...
                    <div className="relative border border-gray-300 rounded-lg overflow-hidden">
                        <img
                            src={previewUrl}
                            alt={`${transactionType} ${getTransactionLabel()}`}
