...
export function EditExpenseModal({ isOpen, onClose, onEdit, categories, expense }: EditExpenseModalProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (!formData.title || !formData.amount || !formData.categoryId || !expense) {
