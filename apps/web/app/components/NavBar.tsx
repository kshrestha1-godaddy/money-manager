        ...
        <div className="flex items-center space-x-4 flex-shrink-0 pr-4">
          ...
          {status === "authenticated" ? (
            <>
              ...
              {/* Thoughts icon link */}
              {status === "authenticated" && (
                <Link href="/notes" className="p-2 rounded-full hover:bg-gray-100 transition-colors" aria-label="Thoughts">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`w-8 h-8 ${pathname?.startsWith('/notes') ? 'text-blue-600' : 'text-gray-500'}`}>
              ...
              {/* Chat icon link */}
              {status === "authenticated" && (
                <Link href="/chat" className="p-2 rounded-full hover:bg-gray-100 transition-colors" aria-label="Chat">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`w-8 h-8 ${pathname?.startsWith('/chat') ? 'text-blue-600' : 'text-gray-500'}`}>
                  ...
                  <div className="absolute right-0 mt-2 w-56 bg-white/95 backdrop-blur-md rounded-2xl shadow-xl border border-gray-200/50 z-50">
                    <div className="py-2">
                      ...
                      <div className="border-t border-gray-100 py-3">
                        ...
                        >
                          <svg className="w-4 h-4 mr-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path
                              strokeLinecap="round"
